...
#getting median for hhincome - chose median as the people who did not reply on the survey - would be more likely to earn lower than mean income:

full %>% 
    filter(w1_nc_hhinc > 0) %>% 
    summary(w1_nc_hhinc)
